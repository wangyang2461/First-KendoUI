/**
 * Represents a basic filter expression. Usually part of a
...
export interface FilterDescriptor {
    ...
    /**
     * The value to which the field is compared. Must be from the same type as the field.
     */
    value?: any;
    /**
...
export interface CompositeFilterDescriptor {
     ...
     * [`CompositeFilterDescriptor`]({% slug api_kendo-data-query_compositefilterdescriptor_kendouiforangular %}).
     * Support the same options as `filter`. Filters can be nested indefinitely.
     */
